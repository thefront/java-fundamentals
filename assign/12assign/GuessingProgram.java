...
public class GuessingProgram {
  ...
  */
  ...
  public static boolean shouldPlayAgain(RandomNumberGuesser oneGame) {
    boolean playAgain;
  ...
  */
  ...
  public static void playOneGame (RandomNumberGuesser mainGame) {
