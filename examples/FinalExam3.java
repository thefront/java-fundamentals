...
public class FinalExam3 extends GradedActivity implements Relatable {
  ...
  */
  ...
  public FinalExam3 (int questions, int missed) {
    double numericScore;        // To hold a numberic score

    // Set the numQuestions and numMissed fields.
    numQuestions = questions;
    numMissed = missed;

    // Calculate the points for each question and the numberic score for this
    // exam.
    pointsEach = 100.0 / questions;
    numericScore = 100.0 - (missed * pointsEach);

    // Call the inherited setScore method to set the numberic score.
  ...
  */
  ...
  /**
      The equals method compares the calling object to the argument object for
      equality.
  ...
  */
  ...
  /**
      The isGreater method determines whether the calling object is greater than
      the argument object.
      @return true if the calling object's score is greater than the argument
      object's score/
  */
  ...
  /**
      The isLess method determines whether the calling object is less than the
      argument object.
      @return true if the calling object's score is less than the argument's
      score
  */
