...
public class CurvedActivity extends GradedActivity {
  ...
  */
  ...
  /**
      The setScore method overrides the superclass setScore method. This version
      accepts the unadjusted score as an argument. That score is multipled by
      the curve percentage and the result is sent as an argument to the
